<template>
  ...
  <el-table :data="tableData.list">
    ...
    <el-table-column label="陪护师手机号" width="110">
      <template #default="scope">
        {{ scope.row.companion.mobile }}
      </template>
    </el-table-column>
    <el-table-column prop="price" label="总价" width="55" />
    <el-table-column prop="paidPrice" label="已付" width="55" />
    ...
    <el-table-column prop="tel" label="联系人手机号" width="110" />
